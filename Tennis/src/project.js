...
System.register("chunks:///GamePlay/Model/Level.js", ["../../_virtual/_rollupPluginBabelHelpers.js", "cc", "../../Common/Cocos.js", "../GameRule.js"], function (_export, _context) {
  ...
  var _createClass, _classCallCheck, cclegacy, disOrderArray, Theme, Level;
    ...
    execute: function () {
      ...
      _export("PlayModel", PlayModel = /*#__PURE__*/function (_SingleTon) {
        ...
        _createClass(PlayModel, [{
          ...
          key: "TimeBonus",
          get: function get() {
            if (GameLogic.inst.HeartCount <= 0) return;
...
System.register("chunks:///GamePlay/UI/ScoreScaleRoot.js", ["../../_virtual/_rollupPluginBabelHelpers.js", "cc", "../../Manager/GameStateController.js", "../Physics/BorderCollider.js", "../../Manager/ResourceController.js", "../Animation/HeartBonusAnimation.js", "../GameLogic.js"], function (_export, _context) {
  "use strict";

  var _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _createClass, _createForOfIteratorHelper, cclegacy, _decorator, tween, v3, Sprite, Tween, Component, GameStateController, HoleName, ResourceController, HeartBonusAnimation, HoleBonusInitSignal, ReadyNextRoundSignal, DropPocketSignal, RefreshHeartBonusSignal, NextRountSignal, _dec, _class, _class2, _temp, ccclass, property, ScoreScaleRoot;
        ...
        function GameLogic() {
          ...
          GameOverSignal.inst.addListener(function () {
            ...
            if (_this.heartCount > 0) {
              PlayModel.inst.addPlayerScore(GetScoreByType(ScoreType.HeartBonus, _this.heartCount), ScoreType.HeartBonus);
            }
            /** nobust 分数 */
      ...
      _export("AudioController", AudioController = /*#__PURE__*/function (_SingleTon) {
        ...
        _createClass(AudioController, [{
          ...
          get: function get() {
            ...
            if (!this.bgm || this.bgm.state != AudioClip.PlayingState.PLAYING) return 1;
...
System.register("chunks:///App/App.js", ["../_virtual/_rollupPluginBabelHelpers.js", "cc", "../Model/PlayModel.js", "../Manager/ResourceController.js", "../GameLoad/InitialFacade.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("App", App = (_dec = ccclass("App"), _dec2 = property(Material), _dec3 = property(SpriteAtlas), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        return App;
      }(Component), _class3.Material = null, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "Test", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///App/VersionLabel.js", ["../_virtual/_rollupPluginBabelHelpers.js", "cc", "../Signal/Signal.js"], function (_export, _context) {
  "use strict";

  var _inherits, _createClass, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, cclegacy, _decorator, Label, Component, GameStartSignal, _dec, _class, ccclass, property, VersionLabel;
      ...
      _export("VersionLabel", VersionLabel = (_dec = ccclass("VersionLabel"), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _createClass(VersionLabel, [{
          ...
          value: function start() {
            ...
            GameStartSignal.inst.addListener(function () {
              _this.getComponent(Label).string = window["GAME_VERSION"] && window["GAME_VERSION"].split("version") && window["GAME_VERSION"].split("version")[1] ? window["GAME_VERSION"].split("version")[1].replace(":", "") : window["DEBUG_VERSION"];
            }, this);
          } // update (deltaTime: number) {
          //     // Your update function goes here.
          // }
...
System.register("chunks:///GamePlay/Animation/ResultAnimation.js", ["../../_virtual/_rollupPluginBabelHelpers.js", "cc", "../../Common/View/SpriteUIAnimation.js"], function (_export, _context) {
  ...
  var _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, cclegacy, _decorator, SpriteUIAnimation, _dec, _class, ccclass, property, ResultAnimation;
        ...
        _createClass(CompleteView, [{
          ...
          value: function onGameOver(type) {
            ...
            if (this.Font.node.active) {
              this.Font.node.scale = v3(0, this.Font.node.scale.y, this.Font.node.scale.z);
...
System.register("chunks:///GamePlay/UI/ResultLayerView.js", ["../../_virtual/_rollupPluginBabelHelpers.js", "cc", "../../Signal/Signal.js", "../../Model/PlayModel.js", "../../Manager/GameStateController.js", "../../Common/SDK/CelerSDK.js", "../../table.js", "../../Common/View/BaseView.js", "../../Manager/ResourceController.js", "../../Common/View/UI/NumberChangedView.js", "../Animation/ResultAnimation.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ResultLayerView", ResultLayerView = (_dec = ccclass("ResultLayerView"), _dec(_class = (_temp = /*#__PURE__*/function (_BaseView) {
        ...
        _createClass(ResultLayerView, [{
          ...
          value: function onGameOver(type) {
            ...
            if (type == RoundEndType.TimeUp) {
              this.Title.spriteFrame = ResourceController.inst.getResultSprite(Title.TimeUp);
            } else if (type == RoundEndType.Complete) {
              this.Title.spriteFrame = ResourceController.inst.getResultSprite(Title.Complete);
            } else if (type == RoundEndType.OutOfMove) {
              this.Title.spriteFrame = ResourceController.inst.getResultSprite(Title.OutOfMove);
            } else {
              this.Title.spriteFrame = ResourceController.inst.getResultSprite(Title.Over);
            }

            this.Title.node.scale = v3(0, 0, 0);
            this.Root.scale = v3(0, 0, 0);
            this.node.active = true;
            tween(this.Root).sequence(tween(this.Root).to(0.1, {
              scale: v3(0.9, 1.3, 1)
            }), tween(this.Root).to(0.1, {
              scale: v3(1.2, 0.9, 1)
            }), tween(this.Root).to(0.1, {
              scale: v3(1, 1, 1)
            }), tween(this.Root).call(this.showInfo.bind(this))).start();
          }
        }, {
          key: "showInfo",
          value: function showInfo() {
            ...
            tween(this.Title).sequence(tween(this.Title).to(0.1, {
              scale: v3(1.5, 1.5, 1.5)
            }), tween(this.Title).to(0.1, {
              scale: v3(1, 1, 1)
            }), tween(this.Title).to(0.1, {
              scale: v3(1.2, 1.2, 1.2)
            }), tween(this.Title).to(0.1, {
            ...
            this.Score.onNumberChanged(PlayModel.inst.getTotalScore() - PlayModel.inst.TimeBonus, function () {
              _this2.Count++;
          ...
          key: "Score",
          get: function get() {
            return this.Root.getChildByName("ScoreLabel").getComponent(NumberChangedView);
          }
          /** 提交按钮 */
          ...
          set: function set(val) {
            ...
            if (this.Count >= this.CountTotal) {
              ...
              tween(this.Submit).sequence(tween(this.Submit).to(0.1, {
                scale: v3(1.2, 1.2, 1.2)
              }), tween(this.Submit).to(0.1, {
                scale: v3(1, 1, 1)
              }), tween(this.Submit).call(function () {
                _this3.Submit.once(Node.EventType.TOUCH_END, function () {
