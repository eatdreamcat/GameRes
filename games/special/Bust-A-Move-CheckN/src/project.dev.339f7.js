window.__require = function e(t, n, r) {
    ...
    var Bird = function(_super) {
      ...
      Bird.prototype.update = function(dt) {
        if (this.fly) {
          ...
          if (Math.abs(CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.TopNode).x) >= BubbleMove_1.BorderX) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.initEvent = function() {
        ...
        this.ChangeButton.node.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          readyBubble.runAction(cc.sequence(cc.delayTime(.1), cc.moveTo(.2, 0, 0), cc.callFunc(function() {
  ...
  LogHandler: [ function(require, module, exports) {
    ...
    var LogHandler = function() {
      ...
      LogHandler.VERSION = "Bust-A-Move version 24 : ";
