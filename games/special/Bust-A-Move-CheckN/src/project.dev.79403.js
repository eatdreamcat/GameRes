window.__require = function e(t, n, r) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.addBubble = function(istart, iend, jstart, jend, factor) {
        ...
        for (var i = istart; i <= iend; i++) for (var j = jstart; j <= jend; j++) {
          ...
          var bubble = Game_1.Game.getBubble(bubbleMatrix.data[index].type, index, bubbleMatrix.data[index].color, this.BubbleAtlas, this.BubbleChange, this.BubbleBurst, this.BubbleHorce, this.BubbleDrop);
      ...
      GameScene.prototype.getNewTask = function(count) {
        ...
        var _loop_3 = function(i) {
          ...
          var bubble = Game_1.Game.getBubble(type, -1, color, this_1.BubbleAtlas, this_1.BubbleChange, this_1.BubbleBurst, this_1.BubbleHorce, this_1.BubbleDrop);
  ...
  LogHandler: [ function(require, module, exports) {
    ...
    var LogHandler = function() {
      ...
      LogHandler.VERSION = "Bust-A-Move version 22 : ";
