window.__require = function e(t, n, r) {
      ...
      AudioController.prototype.bindTouch = function() {
        if (!AudioController.hasBindTouch) {
          ...
          var playFunc_1 = function() {
            ...
            cc.sys.platform == cc.sys.DESKTOP_BROWSER && cc.game.canvas.removeEventListener("click", playFunc_1);
            AudioController.canPlay = true;
            var item;
          ...
          cc.sys.platform == cc.sys.DESKTOP_BROWSER && cc.game.canvas.addEventListener("click", playFunc_1);
        }
      };
  ...
  Bird: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ae760SeGw5Fo6VvYIpO18qP", "Bird");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var GameSignal_1 = require("./Controller/GameSignal");
    ...
    var Bird = function(_super) {
      ...
      function Bird() {
        ...
        _this.velocity = cc.v2(0, 0);
        _this.Speed = cc.v2(400, 800);
        _this.score = 0;
        _this.Scale = 1.2;
        _this.fly = false;
        return _this;
      ...
      Bird_1 = Bird;
      Object.defineProperty(Bird.prototype, "Spine", {
        get: function() {
      ...
      Bird.prototype.reuse = function(score, pos) {
        var _this = this;
        this.score = score;
        this.Spine.setCompleteListener(this.onAnimationComplete.bind(this));
        this.node.setPosition(pos);
        Math.abs(Bird_1.Border) < Math.abs(pos.x) && (Bird_1.Border = Math.abs(pos.x) + 2);
        this.node.scale = 0;
        var targetScale = cc.v2(this.node.x > 0 ? 1 : -1, 1).mul(this.Scale);
        this.node.runAction(cc.sequence(cc.scaleTo(.2, 1.2 * targetScale.x, 1.2 * targetScale.y), cc.scaleTo(.1, targetScale.x, targetScale.y), cc.callFunc(function() {
          _this.startFly();
        })));
        EventManager_1.gEventMgr.once(EventName_1.GlobalEvent.GAME_OVER, function() {
          _this.node.stopAllActions();
          _this.flyDone(1e3, false);
          Game_1.Game.addScore(Const_1.BubbleType.Bird, _this.score, 1.5, CMath.ConvertToNodeSpaceAR(_this.node, Game_1.Game.TopNode).add(cc.v2(.5 * Const_1.BubbleSize.width, .5 * Const_1.BubbleSize.height)));
        }, this);
      };
      Bird.prototype.startFly = function() {
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "chackn");
        this.Spine.loop = true;
        this.Spine.animation = "fly";
        this.velocity.y = this.Speed.y;
        this.velocity.x = this.node.scaleX > 0 ? -this.Speed.x : this.Speed.x;
        this.fly = true;
      };
      Bird.prototype.onAnimationComplete = function(entry) {
        var _this = this;
        switch (entry.animation.name) {
         ...
         case "fly":
          this.velocity.y = .3 * -this.Speed.y;
          this.acceleration.y = this.Speed.y;
          break;

         case "idle":
          setTimeout(function() {
            _this.Spine.loop = false;
            _this.Spine.animation = "idle";
          }, 700 * CMath.getRandom());
        }
      };
      Bird.prototype.update = function(dt) {
        if (this.fly) {
          ...
          this.velocity.y >= this.Speed.y && (this.acceleration.y = 0);
          this.node.setPosition(this.node.position.add(this.velocity.mul(dt)));
          if (CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.TopNode).x > Bird_1.Border) {
            this.velocity.x = -Math.abs(this.velocity.x);
            this.velocity.y = .2 * -this.Speed.y;
            this.acceleration.y = this.Speed.y;
          } else if (CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.TopNode).x < -Bird_1.Border) {
            this.velocity.x = Math.abs(this.velocity.x);
            this.velocity.y = .2 * -this.Speed.y;
            this.acceleration.y = this.Speed.y;
          }
          var distance = CMath.Distance(this.node.position, cc.v2(0, 0));
          (distance <= 200 || this.node.y >= -100) && this.flyDone();
        }
      };
      Bird.prototype.flyDone = function(speed, addScore) {
        var _this = this;
        void 0 === speed && (speed = 500);
        void 0 === addScore && (addScore = true);
        this.fly = false;
        ...
        this.node.scaleX *= this.Scale;
        false == addScore && (this.node.group = "default");
        GameSignal_1.ChacknCountChangedSignal.inst.dispatchOne(Game_1.Game.treasureCount);
        this.node.runAction(cc.sequence(cc.moveTo(distance / speed, cc.v2(0, 0)), cc.callFunc(function() {
          EventManager_1.gEventMgr.targetOff(_this);
          _this.node.scaleX = 1 * _this.Scale;
          _this.node.runAction(cc.scaleTo(.1, 1));
          _this.Spine.loop = false;
          _this.Spine.animation = "idle";
          _this.node.group = "default";
          addScore && Game_1.Game.addScore(Const_1.BubbleType.Bird, _this.score, 1.5, CMath.ConvertToNodeSpaceAR(_this.node, Game_1.Game.TopNode).add(cc.v2(.5 * Const_1.BubbleSize.width, .5 * Const_1.BubbleSize.height)));
          _this.node.getParent().childrenCount >= 3 ? GameFactory_1.gFactory.putBird(_this.node) : _this.node.getParent().getChildByName("back").runAction(cc.fadeOut(.1));
        })));
      };
      var Bird_1;
      Bird.Border = BubbleMove_1.BorderX;
    ...
    "./Controller/GameSignal": "GameSignal"
  } ],
    ...
    var BubbleMatrix = function() {
      function BubbleMatrix() {
        ...
        for (var i = 0; i < exports.MatrixSize * exports.MatrixSize; i++) this.matrixData[i] = {
          ...
          bubble: null,
          type: Const_1.SpecialType.Normal
        };
      }
      ...
      BubbleMatrix.prototype.moveRow = function(row) {
        if (this.addRowTotalCount <= row) {
          ...
          var birdCount = Math.ceil(CMath.getRandom(2, 3));
          var birdData = {};
          while (birdCount > 0 && allIndex.length > 0) {
            var randomI = Math.floor(CMath.getRandom(0, allIndex.length));
            var Index = allIndex[randomI];
            allIndex.splice(randomI, 1);
            var neibers = this.getNeiborMatrix(Index, 1);
            var hasBirdNeiber = false;
            for (var _i = 0, neibers_1 = neibers; _i < neibers_1.length; _i++) {
              var nei = neibers_1[_i];
              if (birdData[nei] == Const_1.BubbleType.Bird) {
                hasBirdNeiber = true;
                break;
              }
            }
            if (hasBirdNeiber) continue;
            birdData[Index] = Const_1.BubbleType.Bird;
            birdCount--;
          }
          ...
          for (var i = 0; i < addCount - 1; i++) {
            ...
            this.matrixData[i].type = Const_1.SpecialType.Normal;
            if (null != doubleData[i]) {
              this.matrixData[i].type = Const_1.SpecialType.Double;
              this.matrixData[i].color = doubleData[i];
            }
            if (null != magicData[i]) {
              this.matrixData[i].type = Const_1.SpecialType.Magic;
              this.matrixData[i].color = magicData[i];
            }
            if (null != boomData[i]) {
              this.matrixData[i].type = Const_1.SpecialType.Boom;
              this.matrixData[i].color = boomData[i];
            }
            if (null != birdData[i]) {
              this.matrixData[i].type = Const_1.SpecialType.Normal;
              this.matrixData[i].color = Const_1.BubbleType.Bird;
            }
          }
        } else {
          this.firstRow -= 1;
      ...
      BubbleMatrix.prototype.getPosOfij = function(i, j) {
        var pos = cc.v2(0, 0);
        pos.x = (j - exports.MatrixSize / 2) * (Const_1.BubbleSize.width + Const_1.BubbleXOffset) + (i + this.firstRow + Game_1.Game.getMoveTimes()) % 2 * Const_1.BubbleSize.width / 2 + Const_1.BubbleStartX;
        ...
        for (var i = 0; i <= range; i++) {
          ...
          for (var j = 0; j <= rangej; j++) {
            ...
            if (index != neiberIndex1 && neibers.indexOf(neiberIndex1) < 0 && neiberIndex1 >= 0 && (neiberIndex1 < this.matrixData.length || isBlank) && (isSame || (newi + moveTimes) % 2 == 0 || j < rangej)) {
              ...
              var rangeSub = 0;
              this.index2i(neiberIndex1) % 2 == 0 && (rangeSub = 1);
              indexJ >= exports.IndexJStart && indexJ <= exports.IndexJEnd - rangeSub && neiberIndex1 >= Game_1.Game.startIndex && (this.data[neiberIndex1] && this.data[neiberIndex1].bubble && !isBlank ? neibers.push(neiberIndex1) : !isBlank || this.data[neiberIndex1] && this.data[neiberIndex1].bubble || neibers.push(neiberIndex1));
            }
            if (index != neiberIndex2 && neibers.indexOf(neiberIndex2) < 0 && neiberIndex2 >= 0 && (neiberIndex2 < this.matrixData.length || isBlank)) {
              ...
              var rangeSub = 0;
              this.index2i(neiberIndex2) % 2 == 0 && (rangeSub = 1);
              indexJ >= exports.IndexJStart && indexJ <= exports.IndexJEnd - rangeSub && neiberIndex2 >= Game_1.Game.startIndex && (isSame || (newi + moveTimes) % 2 == 0 || j < rangej) && (this.data[neiberIndex2] && this.data[neiberIndex2].bubble && !isBlank ? neibers.push(neiberIndex2) : !isBlank || this.data[neiberIndex2] && this.data[neiberIndex2].bubble || neibers.push(neiberIndex2));
            }
            if (index != neiberIndex3 && neibers.indexOf(neiberIndex3) < 0 && neiberIndex3 >= 0 && (neiberIndex3 < this.matrixData.length || isBlank)) {
              ...
              var rangeSub = 0;
              this.index2i(neiberIndex3) % 2 == 0 && (rangeSub = 1);
              indexJ >= exports.IndexJStart && indexJ <= exports.IndexJEnd - rangeSub && neiberIndex3 >= Game_1.Game.startIndex && (isSame || (newi + moveTimes) % 2 || j < rangej) && (this.data[neiberIndex3] && this.data[neiberIndex3].bubble && !isBlank ? neibers.push(neiberIndex3) : !isBlank || this.data[neiberIndex3] && this.data[neiberIndex3].bubble || neibers.push(neiberIndex3));
            }
            if (index != neiberIndex4 && neibers.indexOf(neiberIndex4) < 0 && neiberIndex4 >= 0 && (neiberIndex4 < this.matrixData.length || isBlank)) {
              ...
              var rangeSub = 0;
              this.index2i(neiberIndex4) % 2 == 0 && (rangeSub = 1);
              indexJ >= exports.IndexJStart && indexJ <= exports.IndexJEnd - rangeSub && neiberIndex4 >= Game_1.Game.startIndex && (isSame || (newi + moveTimes) % 2 || j < rangej) && (this.data[neiberIndex4] && this.data[neiberIndex4].bubble && !isBlank ? neibers.push(neiberIndex4) : !isBlank || this.data[neiberIndex4] && this.data[neiberIndex4].bubble || neibers.push(neiberIndex4));
            }
          }
        }
      ...
      BubbleMatrix.prototype.initBubbleData = function() {
        ...
        var birdData = {};
        var birdCountBot = 6;
        var randomStart = allIndex.length - 40;
        while (birdCountBot > 0 && allIndex.length > 0) {
          var randomI = Math.floor(CMath.getRandom(randomStart, allIndex.length));
          var Index = allIndex[randomI];
          allIndex.splice(randomI, 1);
          var neibers = this.getNeiborMatrix(Index, 1, true);
          var hasBirdNeiber = false;
          for (var _i = 0, neibers_2 = neibers; _i < neibers_2.length; _i++) {
            var nei = neibers_2[_i];
            if (birdData[nei] == Const_1.BubbleType.Bird) {
              hasBirdNeiber = true;
              break;
            }
        ...
        var birdCountTop = 4;
        var randomEnd = allIndex.length - 40;
        while (birdCountTop > 0 && allIndex.length > 0) {
          var randomI = Math.floor(CMath.getRandom(0, randomEnd));
          var Index = allIndex[randomI];
          allIndex.splice(randomI, 1);
          randomEnd--;
          var neibers = this.getNeiborMatrix(Index, 1, true);
          var hasBirdNeiber = false;
          for (var _a = 0, neibers_3 = neibers; _a < neibers_3.length; _a++) {
            var nei = neibers_3[_a];
            if (birdData[nei] == Const_1.BubbleType.Bird) {
              hasBirdNeiber = true;
              break;
            }
        ...
        for (var i = startIndex; i <= endIndex; i++) {
          ...
          var neiberColors = [];
          for (var _b = 0, neibers_4 = neibers; _b < neibers_4.length; _b++) {
            var index = neibers_4[_b];
        ...
        for (var i = 0; i < this.matrixData.length; i++) {
          ...
          if (null != Const_1.SpecialIndex[i]) {
            this.matrixData[i].type = Const_1.SpecialIndex[i].type;
            this.matrixData[i].color = Const_1.SpecialIndex[i].color;
          }
        }
    ...
    var BubbleMove = function(_super) {
      ...
      BubbleMove.prototype.checkBorder = function() {
        ...
        if (this.node.x <= -exports.BorderX || this.node.x >= exports.BorderX) {
          this.node.x = this.node.x > 0 ? .999 * exports.BorderX : .999 * -exports.BorderX;
          this.speed.x = -this.speed.x;
          this.acceleration.x = -this.acceleration.x;
          Game_1.Game.Rebounce++;
        }
      };
      ...
      BubbleMove.prototype.checkCollisionBubble = function() {
        ...
        var _loop_1 = function(index) {
          ...
          if (CMath.Distance(bubblePos, bubble.node.position) <= 2 * this_1.radis * .8) {
            ...
            if (this_1.bubble.Type == Const_1.SpecialType.Magic) {
              if (bubble.Type != Const_1.SpecialType.Magic && Const_1.ChangeColorExcept.indexOf(bubble.Color) < 0 && bubble.node.active) {
                this_1.bubble.setColor(bubble.Color, Const_1.SpecialType.Normal);
            ...
            } else if (bubble.Type == Const_1.SpecialType.Magic && bubble.node.active && this_1.bubble.Type != Const_1.SpecialType.Horce && Const_1.ChangeColorExcept.indexOf(this_1.bubble.Color) < 0) {
      ...
      BubbleMove.prototype.shoot = function(deltaP) {
        EventManager_1.gEventMgr.off(EventName_1.GlobalEvent.SHOOT);
        console.log("\u53d1\u5c04\uff01");
        Game_1.Game.Rebounce = 0;
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "shoot");
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.AFTER_SHOOT);
        this.enabled = true;
        this.shooted = true;
      ...
      BubbleMove.prototype.drop = function() {
        ...
        console.log(" \u6389\u843d:", this.enabled, this.bubble.getIndex(), this.speed, this.acceleration, this.hasCollision, "Drop:", Game_1.Game.DropCount);
      };
        ...
        if (this.isShooterState || this.isDrop) {
          ...
          for (var i = 0; i < count; i++) {
            ...
            if (this.isDrop && pos.y <= exports.DropBorder) {
              ...
              Game_1.Game.DropCount--;
              if (this.bubble.Color == Const_1.BubbleType.Bird) {
                EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.GET_TREASURE, ++Game_1.Game.treasureCount, this.node);
                this.bubble.playAnimation(BubbleBurst_1.default, function() {
  ...
  Bubble: [ function(require, module, exports) {
    ...
    var Bubble = function(_super) {
      ...
      function Bubble() {
        ...
        _this.type = Const_1.SpecialType.Normal;
        _this.animationCallback = {};
      ...
      Object.defineProperty(Bubble.prototype, "isDouble", {
        get: function() {
          return this.type == Const_1.SpecialType.Double;
        },
        enumerable: true,
        configurable: true
      });
      ...
      Object.defineProperty(Bubble.prototype, "ChacknBubble", {
        get: function() {
          return this.Bubble.getChildByName("bg_chackn pop");
        },
        enumerable: true,
        configurable: true
      });
      Bubble.prototype.reuse = function(type, index, color, idleFrame, changeFrame, burst, horce, drop, x2) {
        this.node.active = false;
        this.node.scale = 0;
        this.X2 = x2;
        this.type = color == Const_1.BubbleType.Boom ? Const_1.SpecialType.Boom : type == Const_1.SpecialType.Boom ? Const_1.SpecialType.Normal : type;
        this.type == Const_1.SpecialType.Double && color == Const_1.BubbleType.Bird && (this.type = Const_1.SpecialType.Normal);
        this.color = color;
        ...
        this.getAnimation(BubbleDrop_1.default).Animation = drop;
        this.ChacknBubble.active = this.color == Const_1.BubbleType.Bird;
        this.color == Const_1.BubbleType.Bird ? this.Bubble.width = this.Bubble.height = 90 : this.Bubble.width = this.Bubble.height = 92;
        this.sprite.node.opacity = 255;
        this.Double.active = this.type == Const_1.SpecialType.Double;
        this.Double.getComponent(cc.Sprite).spriteFrame = this.X2.getSpriteFrame(Const_1.BubbleX2[this.color]);
      ...
      Bubble.prototype.onClear = function(delayTime, fromIndex) {
        var _this = this;
        if (this.index == fromIndex && Game_1.Game.Rebounce > 0) {
          console.log(" \u53cd\u5f39\u6b21\u6570:", Game_1.Game.Rebounce);
          Game_1.Game.Rebounce = 0;
          var pos = CMath.ConvertToNodeSpaceAR(this.node, Game_1.Game.TopNode);
          Math.abs(pos.x) >= 340 && (pos.x = pos.x > 0 ? 340 : -340);
          EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.SHOW_REBOUNCE, pos);
        }
        if (this.color == Const_1.BubbleType.Bird) {
          this.move.drop();
          return;
        }
        Game_1.Game.addBubbleClear(this.Color);
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, this.type == Const_1.SpecialType.Boom ? "boom" : "clear");
  ...
  ChacknCountView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "bef74UxmRNMJZfHb6cVk/et", "ChacknCountView");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var GameSignal_1 = require("../Controller/GameSignal");
    var NumberChangedView_1 = require("../Utils/NumberChangedView");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var ChacknCountView = function(_super) {
      __extends(ChacknCountView, _super);
      function ChacknCountView() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      ChacknCountView.prototype.onLoad = function() {
        GameSignal_1.ChacknCountChangedSignal.inst.addListenerOne(this.onNumberChanged, this);
      };
      ChacknCountView.prototype.start = function() {};
      ChacknCountView = __decorate([ ccclass ], ChacknCountView);
      return ChacknCountView;
    }(NumberChangedView_1.default);
    exports.default = ChacknCountView;
    cc._RF.pop();
  }, {
    "../Controller/GameSignal": "GameSignal",
    "../Utils/NumberChangedView": "NumberChangedView"
  } ],
  ChacknScoreView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "59b92pUfe5F2a0O3yWwNB3y", "ChacknScoreView");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var NumberChangedView_1 = require("../Utils/NumberChangedView");
    var GameSignal_1 = require("../Controller/GameSignal");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var ChacknScoreView = function(_super) {
      __extends(ChacknScoreView, _super);
      function ChacknScoreView() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      ChacknScoreView.prototype.onLoad = function() {
        GameSignal_1.ChacknScoreChangedSignal.inst.addListenerOne(this.onNumberChanged, this);
      };
      ChacknScoreView.prototype.start = function() {};
      ChacknScoreView.prototype.onDestroy = function() {
        GameSignal_1.ChacknCountChangedSignal.inst.removeTarget(this);
      };
      ChacknScoreView = __decorate([ ccclass ], ChacknScoreView);
      return ChacknScoreView;
    }(NumberChangedView_1.default);
    exports.default = ChacknScoreView;
    cc._RF.pop();
  }, {
    "../Controller/GameSignal": "GameSignal",
    "../Utils/NumberChangedView": "NumberChangedView"
  ...
  Const: [ function(require, module, exports) {
    ...
    (function(BubbleType) {
      ...
      BubbleType[BubbleType["Bird"] = 11] = "Bird";
      ...
      BubbleType[BubbleType["Rebounce"] = 1002] = "Rebounce";
    })(BubbleType = exports.BubbleType || (exports.BubbleType = {}));
    exports.BubbleColors = [ BubbleType.Red, BubbleType.Purple, BubbleType.Green, BubbleType.Blue, BubbleType.White, BubbleType.Boom ];
    var SpecialType;
    ...
    exports.SpecialIndex = {
      47: null,
      48: null,
      49: null
    };
    exports.ChangeColorExcept = [ BubbleType.Bird, BubbleType.Blank ];
    exports.BubbleHeightOffset = -15;
    exports.BubbleYOffset = 1205;
    exports.BubbleXOffset = 3;
    exports.BubbleStartX = 45;
    exports.InitColNumber = 9;
    exports.InitStartIndex = 44;
    exports.BubbleSize = cc.size(83 * 1.1, 83 * 1.1);
  ...
  EventName: [ function(require, module, exports) {
    ...
    (function(GlobalEvent) {
      ...
      GlobalEvent[GlobalEvent["SHOW_REBOUNCE"] = 16] = "SHOW_REBOUNCE";
      GlobalEvent[GlobalEvent["UPDATE_INDEX"] = 17] = "UPDATE_INDEX";
      GlobalEvent[GlobalEvent["UPDATE_POINTER_ROTATION"] = 18] = "UPDATE_POINTER_ROTATION";
      GlobalEvent[GlobalEvent["ON_POINTER_ROTATED"] = 19] = "ON_POINTER_ROTATED";
      GlobalEvent[GlobalEvent["IS_GREEN_IDLE"] = 20] = "IS_GREEN_IDLE";
      GlobalEvent[GlobalEvent["GET_CHANGE_BUTTON"] = 21] = "GET_CHANGE_BUTTON";
      GlobalEvent[GlobalEvent["PLAY_LOAD"] = 22] = "PLAY_LOAD";
      GlobalEvent[GlobalEvent["BUBBLE_LOAD"] = 23] = "BUBBLE_LOAD";
      GlobalEvent[GlobalEvent["OPEN_PAUSE"] = 24] = "OPEN_PAUSE";
      GlobalEvent[GlobalEvent["READY_GO"] = 25] = "READY_GO";
      GlobalEvent[GlobalEvent["SHOW_START"] = 26] = "SHOW_START";
      GlobalEvent[GlobalEvent["Hide_Load"] = 27] = "Hide_Load";
      GlobalEvent[GlobalEvent["AFTER_SHOOT"] = 28] = "AFTER_SHOOT";
      GlobalEvent[GlobalEvent["ON_HIDE"] = 29] = "ON_HIDE";
      GlobalEvent[GlobalEvent["ON_SHOW"] = 30] = "ON_SHOW";
  ...
  GameFactory: [ function(require, module, exports) {
    ...
    (function(Step) {
      ...
      Step[Step["Bird"] = 128] = "Bird";
      Step[Step["DONE"] = 252] = "DONE";
    })(Step || (Step = {}));
    var GameFactory = function() {
      function GameFactory() {
        ...
        this.BirdPool = new HashMap_1.HashMap();
      }
      ...
      GameFactory.prototype.init = function(callback, bubble, point, task, score, font, bird) {
      ...
      GameFactory.prototype.initBird = function(initCount, prefab) {
        var self = this;
        if (prefab) {
          self.BirdPool.add("Bird", new ObjPool(prefab, initCount));
          self.nextStep(Step.Bird);
        } else cc.loader.loadRes("prefabs/Bird", cc.Prefab, function(err, prefabRes) {
          if (err) console.error(err); else {
            self.BirdPool.add("Bird", new ObjPool(prefabRes, initCount));
            self.nextStep(Step.Bird);
          }
        });
      };
      GameFactory.prototype.getBird = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
        var _a;
        return (_a = this.BirdPool.get("Bird")).get.apply(_a, args);
      };
      GameFactory.prototype.putBird = function(Bird) {
        this.BirdPool.get("Bird").put(Bird);
      };
      return GameFactory;
    }();
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      function GameScene() {
        ...
        _this.BubbleAtlas = [];
        _this.BubbleChange = null;
        _this.X2 = null;
        _this.BubbleBurst = [];
        _this.BubbleHorce = null;
        _this.BubbleDrop = null;
        _this.SpringBack = null;
        _this.SummerBack = null;
        _this.AutumnBack = null;
        _this.WinterBack = null;
        _this.SpringMask = null;
        _this.SummerMask = null;
        _this.AutumnMask = null;
        _this.WinterMask = null;
        _this.MaskMachine = null;
        ...
        _this.BirdRoot = null;
        _this.PsitonLeft = null;
        _this.PsitonRight = null;
        _this.showScore = 0;
        _this.score = 0;
        _this.addScoreStep = 0;
        _this.psitonOffset = -50;
        _this.TreasureProgress = [ 0, 0, .3, .5, .8, 1 ];
        return _this;
      }
      GameScene.prototype.onLoad = function() {
        this.BirdRoot.active = true;
        this.PauseButton.node.active = true;
        this.ChangeCube.active = false;
        this.ChangeButton.node.active = false;
        this.ChangeButton.interactable = false;
        this.ShooterLayer.active = false;
        CELER_X && LogHandler_1.LogHandler.inst.initLog(celerSDK.log);
        LogHandler_1.LogHandler.inst.log(" game scene on load:", window.location ? window.location.href : "null location");
        ...
        var self = this;
        CELER_X && celerSDK.onStart(function() {
          self.celerOnStart();
        }.bind(this));
        ...
        }, this.BubblePrefab, this.PointPrefab, this.TaskPrefab, this.AddScorePrefab, this.FontPrefab, this.BirdPrefab);
      ...
      GameScene.prototype.celerReady = function() {
        LogHandler_1.LogHandler.inst.log(" call celerx.ready:", CELER_X);
        CELER_X && celerSDK.ready();
        CELER_X || this.celerOnStart();
      };
      GameScene.prototype.celerOnStart = function() {
        var match = CELER_X ? celerSDK.getMatch() : {
          matchId: "",
        ...
        if (match && match.sharedRandomSeed) {
          ...
          CMath.randomSeed = .6554873874384882;
        }
        LogHandler_1.LogHandler.inst.log(" celer on start:", Game_1.Game.MatchInfo);
        Game_1.Game.prepare();
        Game_1.Game.start();
        this.updateSeason();
        this.show();
        this.ShooterLayer.active = true;
        if (match && match.shouldLaunchTutorial || true) {
        ...
        CELER_X ? EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.Hide_Load, 3) : EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.Hide_Load);
      };
      ...
      GameScene.prototype.initEvent = function() {
        ...
        this.ChangeButton.node.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          shooterBubble.setPosition(CMath.ConvertToNodeSpaceAR(shooterBubble, _this.ReadyShooter));
          shooterBubble.setParent(_this.ReadyShooter);
          shooterBubble.getComponent(BubbleMove_1.default).unreadyToShoot();
          shooterBubble.runAction(cc.sequence(cc.moveTo(.15, -15, 88), cc.moveTo(.1, 0, 0)));
          readyBubble.setPosition(CMath.ConvertToNodeSpaceAR(readyBubble, _this.Shooter));
          readyBubble.setParent(_this.Shooter);
          readyBubble.runAction(cc.sequence(cc.fadeTo(0, 255), cc.scaleTo(.1, 1.2, 1.4), cc.scaleTo(0, 1, 1.4), cc.spawn(cc.scaleTo(.1, .8, 1.6), cc.moveBy(.1, 0, _this.psitonOffset).easing(cc.easeIn(.1))), cc.moveTo(0, 0, 0), cc.scaleTo(0, 0, 0), cc.scaleTo(.1, 1, 1), cc.callFunc(function() {})));
          setTimeout(function() {
        ...
        this.PsitonLeft.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          var changeArr = [ {
            ...
            color: Const_1.BubbleType.Boom
          }, {
            type: Const_1.SpecialType.Double,
            color: Const_1.BubbleType.Blank
          }, {
            type: Const_1.SpecialType.Horce,
            color: Const_1.BubbleType.Horce
          }, {
            type: Const_1.SpecialType.Magic,
            color: Const_1.BubbleType.Blank
          }, {
            type: Const_1.SpecialType.Normal,
            color: Const_1.BubbleType.Bird
          } ];
          var readyBubble = _this.ReadyShooter.children[0];
          var type = changeArr[_this["changeCount"]++ % changeArr.length];
          type.type == Const_1.SpecialType.Double && (type.color = Const_1.BubbleColors[Math.floor(CMath.getRandom() * Const_1.BubbleColors.length)]);
          if (readyBubble) {
            var aniName = null;
            if (type.type == Const_1.SpecialType.Horce) {
              aniName = BubbleHorce_1.default;
              EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_horce");
            } else {
              aniName = BubbleChange_1.default;
              EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_color");
            }
            readyBubble.getComponent(Bubble_1.default).setColor(type.color, type.type);
            readyBubble.getComponent(Bubble_1.default).playAnimation(aniName, function() {
              readyBubble.getComponent(Bubble_1.default).AnimationRoot.runAction(cc.fadeOut(.2));
            });
          }
        }, this);
        ...
        this.PsitonRight.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          var shooterBubble = _this.Shooter.children[0];
          if (shooterBubble) {
            var index = colors.indexOf(shooterBubble.getComponent(Bubble_1.default).Color);
            index >= 0 && colors.splice(index, 1);
            var color = colors[_this["changeColorCount"]++ % colors.length];
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_color");
            color == Const_1.BubbleType.Boom ? shooterBubble.getComponent(Bubble_1.default).setColor(color, Const_1.SpecialType.Boom) : shooterBubble.getComponent(Bubble_1.default).setColor(color, Const_1.SpecialType.Normal);
            shooterBubble.getComponent(Bubble_1.default).playAnimation(BubbleChange_1.default, function() {
              shooterBubble.getComponent(Bubble_1.default).AnimationRoot.runAction(cc.fadeOut(.2));
            });
          }
        }, this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.GET_TREASURE, function(name, bubble) {
          var bird = GameFactory_1.gFactory.getBird(500, CMath.ConvertToNodeSpaceAR(bubble, _this.BirdRoot));
          _this.BirdRoot.addChild(bird);
        }, this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.SHOW_REBOUNCE, function(pos) {
          var fontNode = GameFactory_1.gFactory.getFont();
          fontNode.getComponent(cc.Sprite).spriteFrame = _this.FontAtlas.getSpriteFrame("f_rebound");
          fontNode.scale = 0;
          fontNode.opacity = 255;
          _this.TopNode.addChild(fontNode);
          fontNode.x = 0;
          var targetScale = 1;
          fontNode.setPosition(pos);
          fontNode.group = "effect";
          EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "font");
          fontNode.runAction(cc.sequence(cc.scaleTo(.1, targetScale), cc.callFunc(function() {
            Game_1.Game.addScore(Const_1.BubbleType.Rebounce, 50, 2, cc.v2(fontNode.x + fontNode.width / 2, fontNode.y), false);
          }, _this), cc.delayTime(.6), cc.spawn(cc.scaleTo(.2, 1), cc.fadeTo(.2, 0)), cc.callFunc(function() {
        ...
        EventManager_1.gEventMgr.once(EventName_1.GlobalEvent.GAME_OVER, function(type) {
          ...
          _this.ResultFont.node.runAction(cc.sequence(cc.scaleTo(.1, 1.5), cc.delayTime(.5), cc.scaleTo(.1, 1.2), cc.callFunc(function() {
            cc.loader.loadRes("prefabs/Spring/ResultLayer", cc.Prefab, function(err, prefab) {
              if (err) {
                ...
                CELER_X && celerSDK.submitScore(Game_1.Game.getScore());
              } else {
                var title_1;
                title_1 = type == Const_1.OverType.OUT_OF_MOVE ? _this.ResultTitle.getSpriteFrame("bg_result_font2") : _this.ResultTitle.getSpriteFrame("bg_result_font1");
                setTimeout(function() {
                  var resultLayer = cc.instantiate(prefab);
                  resultLayer.getComponent(ResultLayer_1.default).setTexture(title_1);
      ...
      GameScene.prototype.addBubble = function(istart, iend, jstart, jend, factor) {
        ...
        for (var i = istart; i <= iend; i++) {
          var jEnding = jend;
          i % 2 == 0 && (jEnding = jEnd1);
          for (var j = jstart; j <= jEnding; j++) {
            var index = bubbleMatrix.ij2index(i, j);
            var bubble = Game_1.Game.getBubble(bubbleMatrix.data[index].type, index, bubbleMatrix.data[index].color, this.BubbleAtlas, this.BubbleChange, this.BubbleBurst, this.BubbleHorce, this.BubbleDrop, this.X2);
      ...
      GameScene.prototype.putNextShooterBubble = function() {
        ...
        bubble.scale = 1;
        bubble.runAction(cc.sequence(cc.fadeTo(0, 255), cc.scaleTo(.1, 1.2, 1.4), cc.scaleTo(0, 1, 1.4), cc.spawn(cc.scaleTo(.1, .8, 1.6), cc.moveBy(.1, 0, this.psitonOffset).easing(cc.easeIn(.1))), cc.moveTo(0, 0, 0), cc.scaleTo(0, 0, 0), cc.scaleTo(.1, 1, 1), cc.callFunc(function() {
          console.log(" ready bubble ready to shoot");
          if (bubble.getComponent(Bubble_1.default).Type == Const_1.SpecialType.Normal && true) {
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_horce");
            bubble.getComponent(Bubble_1.default).setColor(Const_1.BubbleType.Horce, Const_1.SpecialType.Horce);
        ...
        if (this.ChangeCube.active) if (this.ChangeShooter.childrenCount > 0) {
          ...
          bubble2Ready_3.runAction(cc.sequence(cc.moveBy(.1, 0, this.psitonOffset), cc.scaleTo(0, 0), cc.moveTo(0, 0, 0)));
          EventManager_1.gEventMgr.once(EventName_1.GlobalEvent.BUBBLE_LOAD, function() {
      ...
      GameScene.prototype.getNewTask = function(count) {
        ...
        var _loop_3 = function(i) {
          ...
          var type = Const_1.SpecialType.Normal;
          if (doubleData[i]) {
            type = Const_1.SpecialType.Double;
            color = doubleData[i];
          }
          ...
          var bubble = Game_1.Game.getBubble(type, -1, color, this_1.BubbleAtlas, this_1.BubbleChange, this_1.BubbleBurst, this_1.BubbleHorce, this_1.BubbleDrop, this_1.X2);
          ...
          if (0 == i) {
            ...
            bubble.runAction(cc.sequence(cc.fadeTo(0, 255), cc.moveTo(0, 0, 0), cc.callFunc(function() {})));
            setTimeout(function() {
              if (horce_1) {
                EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_horce");
                bubble.getComponent(Bubble_1.default).setColor(Const_1.BubbleType.Horce, Const_1.SpecialType.Horce);
            ...
            bubble.stopActionByTag(Bubble_1.BubbleAction.Bubble);
            bubble.scale = 0;
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_LOAD);
        ...
        var targetCount = 0;
        targetCount = Game_1.Game.getGameTime() >= 60 ? random <= .7 ? CMath.Clamp(count - Math.ceil(CMath.getRandom(2, 10)), Const_1.ClearTargetRange.Max, Const_1.ClearTargetRange.Min) : random <= .3 ? CMath.Clamp(count - Math.ceil(CMath.getRandom(1, 2)), Const_1.ClearTargetRange.Max, Const_1.ClearTargetRange.Min) : CMath.Clamp(count, Const_1.ClearTargetRange.Max, Const_1.ClearTargetRange.Min) : random <= .6 ? CMath.Clamp(count - Math.ceil(CMath.getRandom(1, 2)), Const_1.ClearTargetRange.Max, Const_1.ClearTargetRange.Min) : random <= .3 ? CMath.Clamp(count - Math.ceil(CMath.getRandom(2, 10)), Const_1.ClearTargetRange.Max, Const_1.ClearTargetRange.Min) : CMath.Clamp(count, Const_1.ClearTargetRange.Max, Const_1.ClearTargetRange.Min);
      ...
      GameScene.prototype.addScore = function(score, scale, pos, isFLoat) {
        var _this = this;
        void 0 === pos && (pos = cc.v2(0, 0));
        void 0 === isFLoat && (isFLoat = true);
        if (false == isFLoat) {
          this.score = Game_1.Game.getPureScore();
        ...
        scoreLabel.runAction(cc.sequence(cc.scaleTo(.1, 1.2 * scale), cc.delayTime(.2), cc.scaleTo(.1, 1 * scale), cc.moveTo(moveTime, this.ScoreLabel.node.position).easing(cc.easeInOut(1)), cc.scaleTo(.3, 0), cc.callFunc(function() {
          _this.score = Game_1.Game.getPureScore();
      ...
      GameScene.prototype.update = function(dt) {
        ...
        this.ChangeButton.interactable = this.ReadyShooter.childrenCount > 0 && this.Shooter.childrenCount > 0 && Math.abs(this.Shooter.children[0].x) <= .01 && Math.abs(this.Shooter.children[0].y) <= .01 && Math.abs(this.ReadyShooter.children[0].x) <= .01 && Math.abs(this.ReadyShooter.children[0].y) <= .01;
      ...
      __decorate([ property(cc.Prefab) ], GameScene.prototype, "BirdPrefab", void 0);
      ...
      __decorate([ property(cc.SpriteAtlas) ], GameScene.prototype, "X2", void 0);
      ...
      __decorate([ property(cc.SpriteFrame) ], GameScene.prototype, "SpringMask", void 0);
      __decorate([ property(cc.SpriteFrame) ], GameScene.prototype, "SummerMask", void 0);
      __decorate([ property(cc.SpriteFrame) ], GameScene.prototype, "AutumnMask", void 0);
      __decorate([ property(cc.SpriteFrame) ], GameScene.prototype, "WinterMask", void 0);
      __decorate([ property(cc.Sprite) ], GameScene.prototype, "MaskMachine", void 0);
      ...
      __decorate([ property(cc.Node) ], GameScene.prototype, "BirdRoot", void 0);
      __decorate([ property(cc.Node) ], GameScene.prototype, "PsitonLeft", void 0);
      __decorate([ property(cc.Node) ], GameScene.prototype, "PsitonRight", void 0);
  ...
  GameSignal: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5b11cqe4MZNk4psFqqHILEE", "GameSignal");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Signal_1 = require("../Utils/Signal");
    var ChacknCountChangedSignal = function(_super) {
      __extends(ChacknCountChangedSignal, _super);
      function ChacknCountChangedSignal() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      return ChacknCountChangedSignal;
    }(Signal_1.BaseSignal);
    exports.ChacknCountChangedSignal = ChacknCountChangedSignal;
    var ChacknScoreChangedSignal = function(_super) {
      __extends(ChacknScoreChangedSignal, _super);
      function ChacknScoreChangedSignal() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      return ChacknScoreChangedSignal;
    }(Signal_1.BaseSignal);
    exports.ChacknScoreChangedSignal = ChacknScoreChangedSignal;
    cc._RF.pop();
  }, {
    "../Utils/Signal": "Signal"
  } ],
  Game: [ function(require, module, exports) {
    ...
    var EventManager_1 = require("./EventManager");
    var EventName_1 = require("./EventName");
    var GameSignal_1 = require("./GameSignal");
    var GameCtrl = function() {
      ...
      GameCtrl.prototype.addScore = function(color, score, scale, pos, isFloat) {
        void 0 === pos && (pos = cc.v2(0, 0));
        void 0 === isFloat && (isFloat = true);
        this.score += score;
        this.score = Math.max(0, this.score);
        this.addBubbleScore(color, score);
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.ADD_SCORE, score, scale, pos, isFloat);
      };
      ...
      GameCtrl.prototype.checkOutOfMove = function() {
        ...
        if (lastBubble) {
          ...
          if (pos.y <= BubbleMove_1.DropBorder) {
            this.isStart = false;
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.GAME_OVER, Const_1.OverType.OUT_OF_MOVE);
          }
        }
      };
      ...
      GameCtrl.prototype.getBubble = function(type, index, color, idleFrames, changeFrame, burst, horce, drop, x2) {
        return GameFactory_1.gFactory.getBubble(type, index, color, idleFrames, changeFrame, burst, horce, drop, x2);
      };
      ...
      GameCtrl.prototype.addBubbleScore = function(color, score) {
        ...
        color == Const_1.BubbleType.Bird && GameSignal_1.ChacknScoreChangedSignal.inst.dispatchOne(this.bubbleScore[color]);
      };
      GameCtrl.prototype.getSocreByType = function(type) {
        if (!this.bubbleScore[type]) return 0;
        return this.bubbleScore[type];
      };
      GameCtrl.prototype.getPureScore = function() {
        var birdScore = this.getSocreByType(Const_1.BubbleType.Bird);
        return Math.max(this.score - birdScore, 0);
      };
      ...
      GameCtrl.prototype.checkBoomBubble = function(indexs) {
        for (var _i = 0, indexs_1 = indexs; _i < indexs_1.length; _i++) {
          ...
          if (this.bubbleMatrix.data[index].type == Const_1.SpecialType.Boom) {
            ...
            for (var _a = 0, neibers_2 = neibers; _a < neibers_2.length; _a++) {
              ...
              if (this.clearIndex.indexOf(nei) < 0 && nei >= this.startIndex) {
                ...
                this.bubbleMatrix.data[nei].type == Const_1.SpecialType.Boom && nextCheck.push(nei);
              }
            }
      ...
      GameCtrl.prototype.checkClear = function(index, checkBubble, colisionBubble) {
        this.clearIndex.length = 0;
        if (checkBubble.Type == Const_1.SpecialType.Horce) {
          console.log("\u5c0f\u9a6c\u7403:", this.startIndex, Const_1.BubbleType[colisionBubble.Color]);
          this.clearIndex.push(index);
        ...
        if (this.clearIndex.length < Const_1.ClearCountLimit && checkBubble.Type != Const_1.SpecialType.Horce) {
          this.clearIndex.length = 0;
          this.streak = 0;
          return;
        }
        ...
        for (var i_3 = 0; i_3 < this.clearIndex.length; i_3++) {
          ...
          this.bubbleMatrix.data[clear].type = Const_1.SpecialType.Normal;
        }
        this.clearIndex.length = 0;
      ...
      GameCtrl.prototype.checkAddBubble = function() {
        var count = 0;
        for (var i = this.startIndex + 14; i <= this.startIndex + 14 + 9; i++) this.bubbleMatrix.data[i] && this.bubbleMatrix.data[i].bubble && this.bubbleMatrix.data[i].bubble.node.active && count++;
        console.log(" top three count:", count);
        count <= 5 && EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.ADD_BUBBLE, 2);
      };
      ...
      GameCtrl.prototype.checkBubbleDrop = function() {
        ...
        for (var _d = 0, _e = this.dropIndex; _d < _e.length; _d++) {
          ...
          if (bubble) {
            ...
            this.bubbleMatrix.data[index].type = Const_1.SpecialType.Normal;
          }
        }
        this.dropIndex.length = 0;
      };
  ...
  Guide: [ function(require, module, exports) {
    ...
    var Guide = function(_super) {
      ...
      Guide.prototype.onLoad = function() {
        ...
        this.Close.node.on(cc.Node.EventType.TOUCH_END, this.hide, this);
      ...
      Guide.prototype.show = function(closeCallback) {
        ...
        setTimeout(function() {
          _this.Close.node.active = false;
          _this.Next.node.active = true;
        }, 0);
      };
      Guide.prototype.nextPage = function() {
        var _this = this;
        EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "button_click");
        if (this.GuideView.getCurrentPageIndex() >= this.GuideView.content.childrenCount - 1) setTimeout(function() {
          _this.Next.node.active = false;
          _this.Close.node.active = true;
        }, 0); else {
      ...
      Guide.prototype.updateButton = function() {
        var _this = this;
        this.GuideView.getCurrentPageIndex() >= this.GuideView.content.childrenCount - 1 ? setTimeout(function() {
          _this.Next.node.active = false;
          _this.Close.node.active = true;
      ...
      __decorate([ property(cc.Button) ], Guide.prototype, "Close", void 0);
  ...
  LoadingImg: [ function(require, module, exports) {
    ...
    var LoadingImg = function(_super) {
      ...
      LoadingImg.prototype.onLoad = function() {
        ...
        EventManager_1.gEventMgr.targetOff(this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.Hide_Load, function(delay) {
          void 0 === delay && (delay = 0);
          var delayTime = 0;
          Date.now() - _this.startTime <= 5e3 && (delayTime = (5e3 - (Date.now() - _this.startTime)) / 1e3);
          _this.node.runAction(cc.sequence(cc.delayTime(delayTime + delay), cc.fadeOut(.05), cc.callFunc(function() {
  ...
  LogHandler: [ function(require, module, exports) {
    ...
    var LogHandler = function() {
      ...
      LogHandler.VERSION = "Bust-A-Move version 49 : ";
  ...
  NumberChangedView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "6a0e8jwfZxCE7vmfMKFvdKT", "NumberChangedView");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var NumberChangedView = function(_super) {
      __extends(NumberChangedView, _super);
      ...
      Object.defineProperty(NumberChangedView.prototype, "Label", {
        get: function() {
          return this.label ? this.label : this.label = this.node.getComponent(cc.Label);
        },
        enumerable: true,
        configurable: true
      });
      NumberChangedView.prototype.onLoad = function() {};
      NumberChangedView.prototype.start = function() {};
      NumberChangedView.prototype.onNumberChanged = function(num) {
        this.num = num;
        this.num != this.showNum ? this.step = Math.ceil((this.num - this.showNum) / 120) : this.step = 0;
      };
      NumberChangedView.prototype.update = function(dt) {
        ...
        this.Label.string = this.showNum.toString();
      };
      NumberChangedView = __decorate([ ccclass ], NumberChangedView);
      return NumberChangedView;
    }(cc.Component);
    exports.default = NumberChangedView;
    cc._RF.pop();
  }, {} ],
  PauseLayer: [ function(require, module, exports) {
    ...
    var PauseLayer = function(_super) {
      ...
      Object.defineProperty(PauseLayer.prototype, "EndNow", {
        get: function() {
      ...
      PauseLayer.prototype.onLoad = function() {
        ...
        this.EndNow.on(cc.Node.EventType.TOUCH_END, function() {
          EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "button_click");
          _this.hide();
          EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.GAME_OVER, Const_1.OverType.TIME_UP);
        }, this);
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.ON_SHOW, function() {}, this);
  ...
  Psiton: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5c367a1qjBEFYPKZJtSQSpU", "Psiton");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var EventManager_1 = require("./Controller/EventManager");
    var EventName_1 = require("./Controller/EventName");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var Psiton = function(_super) {
      __extends(Psiton, _super);
      function Psiton() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.targetPosition = cc.v2(0, 0);
        _this.startPosition = cc.v2(0, 0);
        return _this;
      }
      Psiton.prototype.onLoad = function() {
        this.defaultPosition = this.node.position.clone();
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.AFTER_SHOOT, this.onShoot, this);
      };
      Psiton.prototype.start = function() {};
      Psiton.prototype.onShoot = function() {
        this.node.runAction(cc.sequence(cc.spawn(cc.scaleTo(.05, .9), cc.moveTo(.05, this.startPosition)), cc.delayTime(.05), cc.spawn(cc.moveTo(.05, this.targetPosition), cc.scaleTo(.05, 1)), cc.moveTo(.05, this.defaultPosition)));
      };
      __decorate([ property(cc.Vec2) ], Psiton.prototype, "targetPosition", void 0);
      __decorate([ property(cc.Vec2) ], Psiton.prototype, "startPosition", void 0);
      Psiton = __decorate([ ccclass ], Psiton);
      return Psiton;
    }(cc.Component);
    exports.default = Psiton;
    cc._RF.pop();
  }, {
    "./Controller/EventManager": "EventManager",
    "./Controller/EventName": "EventName"
  ...
  ReadyGoAnimation: [ function(require, module, exports) {
    ...
    var ReadyGo = function(_super) {
      ...
      ReadyGo.prototype.registerEvent = function() {
        if (CELER_X) {
          celerSDK.onPause(function() {
            if (false == Game_1.Game.isStart) return;
            console.log(" game on background");
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.OPEN_PAUSE);
          });
          celerSDK.onResume(function() {
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.ON_SHOW);
          });
        } else {
  ...
  ResultLayer: [ function(require, module, exports) {
    ...
    var ResultLayer = function(_super) {
      ...
      ResultLayer.prototype.onLoad = function() {
        ...
        this.updateScore();
        this.Equip.getChildByName("Back").opacity = 255;
        this.Equip.getChildByName("Bird").scale = 0;
        if (Game_1.Game.treasureCount > 0) {
          this.Equip.getChildByName("Back").runAction(cc.sequence(cc.delayTime(0), cc.fadeOut(.1)));
          this.Equip.getChildByName("Bird").runAction(cc.sequence(cc.delayTime(0), cc.scaleTo(.1, 1.2), cc.scaleTo(.1, 1)));
        }
        this.Submit.scale = 0;
        this.Result.scale = 0;
      ...
      ResultLayer.prototype.updateScore = function() {
        this.bonusScore = 0;
        this.bonus = 0;
        this.totalScore = Game_1.Game.getScore();
        this.gameScore = Game_1.Game.getPureScore();
        this.bonusScore = Game_1.Game.getSocreByType(Const_1.BubbleType.Bird);
        this.bonus = Game_1.Game.treasureCount;
      ...
      ShooterLayer.prototype.updatePoint = function(k, direction) {
        ...
        if (null === k) for (var i = 0; i < childrenCount; i++) {
          ...
          for (var i = 0; i < childrenCount; i++) {
            var child = this.Point.children[i];
            var lastChild = this.Point.children[i - 1];
            child.opacity = 255 - i / childrenCount * POINT_OPCIATY;
  ...
  Signal: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "1d887L8WQZKNbLn/jQjfYEq", "Signal");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var ToSingleton_1 = require("./ToSingleton");
    var BaseSignal = function(_super) {
      __extends(BaseSignal, _super);
      function BaseSignal() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.listenerMap = [];
      ...
      BaseSignal.prototype.doDispatch = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
        this.excuteListener.apply(this, args);
        this.excuteOnce.apply(this, args);
      };
      BaseSignal.prototype.excuteListener = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
        if (this.listenerMap && this.listenerMap.length > 0) for (var _a = 0, _b = this.listenerMap; _a < _b.length; _a++) {
          var listener = _b[_a];
          listener.callback.apply(listener.target, args);
        }
      };
      BaseSignal.prototype.excuteOnce = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
        if (this.onceListenerMap && this.onceListenerMap.length > 0) {
          for (var _a = 0, _b = this.onceListenerMap; _a < _b.length; _a++) {
            var listener = _b[_a];
            listener.callback.apply(listener.target, args);
          }
      ...
      BaseSignal.prototype.listen = function(callback, target) {
        this.listenerMap.push({
          callback: callback,
          target: target
        });
      };
      BaseSignal.prototype.listenOnce = function(callback, target) {
        this.onceListenerMap.push({
          callback: callback,
          target: target
        });
      };
      BaseSignal.prototype.removeListener = function(callback, target) {
        if (this.listenerMap && this.listenerMap.length > 0) for (var i = 0; i < this.listenerMap.length; ++i) {
      ...
      BaseSignal.prototype.removeTarget = function(target) {
        if (this.listenerMap && this.listenerMap.length > 0) for (var i = 0; i < this.listenerMap.length; ++i) {
          var listener = this.listenerMap[i];
      ...
      BaseSignal.prototype.dispatch = function() {
        this.doDispatch(null);
      };
      BaseSignal.prototype.dispatchOne = function(val) {
        this.doDispatch(val);
      };
      BaseSignal.prototype.dispatchTwo = function(val1, val2) {
        this.doDispatch(val1, val2);
      };
      BaseSignal.prototype.dispatchThree = function(val1, val2, val3) {
        this.doDispatch(val1, val2, val3);
      };
      BaseSignal.prototype.dispatchFour = function(val1, val2, val3, val4) {
        this.doDispatch(val1, val2, val3, val4);
      };
      BaseSignal.prototype.dispatchFive = function(val1, val2, val3, val4, val5) {
        this.doDispatch(val1, val2, val3, val4, val5);
      };
      BaseSignal.prototype.addListener = function(callback, target) {
        this.listen(callback, target);
      };
      BaseSignal.prototype.addOnce = function(callback, target) {
        this.listenOnce(callback, target);
      };
      BaseSignal.prototype.addListenerOne = function(callback, target) {
        this.listen(callback, target);
      };
      BaseSignal.prototype.addListenerTwo = function(callback, target) {
        this.listen(callback, target);
      };
      BaseSignal.prototype.addListenerThree = function(callback, target) {
        this.listen(callback, target);
      };
      BaseSignal.prototype.addListenerFour = function(callback, target) {
        this.listen(callback, target);
      };
      BaseSignal.prototype.addListenerFive = function(callback, target) {
        this.listen(callback, target);
      };
      BaseSignal.prototype.addOnceOne = function(callback, target) {
        this.listenOnce(callback, target);
      };
      BaseSignal.prototype.addOnceTwo = function(callback, target) {
        this.listenOnce(callback, target);
      };
      BaseSignal.prototype.addOnceThree = function(callback, target) {
        this.listenOnce(callback, target);
      };
      BaseSignal.prototype.addOnceFour = function(callback, target) {
        this.listenOnce(callback, target);
      };
      BaseSignal.prototype.addOnceFive = function(callback, target) {
        this.listenOnce(callback, target);
      };
      return BaseSignal;
    }(ToSingleton_1.SingleTon());
    exports.BaseSignal = BaseSignal;
    cc._RF.pop();
  }, {
    ...
    var StartButton = function(_super) {
      ...
      StartButton.prototype.onLoad = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.SHOW_START, function(hide) {
          _this.node.getParent().active = hide;
          _this.node["_touchid"] = null;
        }, this);
        this.node.on(cc.Node.EventType.TOUCH_END, function() {
          ...
          _this.node.getParent().removeFromParent(true);
        }, this);
      };
  ...
  ToSingleton: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "0b717hJnuhFk4sfelXowcMt", "ToSingleton");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    function SingleTon() {
      var ToSingleTon = function() {
        function ToSingleTon() {}
        Object.defineProperty(ToSingleTon, "inst", {
          get: function() {
