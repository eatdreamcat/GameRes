window.__require = function e(t, n, r) {
    ...
    var Bird = function(_super) {
      ...
      Bird.prototype.reuse = function(score, pos) {
        ...
        EventManager_1.gEventMgr.once(EventName_1.GlobalEvent.GAME_OVER, function() {
          ...
          Game_1.Game.addScore(_this.score, _this.score, 1.5, CMath.ConvertToNodeSpaceAR(_this.node, Game_1.Game.TopNode).add(cc.v2(.5 * Const_1.BubbleSize.width, .5 * Const_1.BubbleSize.height)));
        }, this);
      };
      ...
      Bird.prototype.flyDone = function(speed, addScore) {
        ...
        this.node.runAction(cc.sequence(cc.moveTo(distance / speed, cc.v2(0, 0)), cc.callFunc(function() {
          ...
          _this.Spine.loop = false;
          _this.Spine.animation = "idle";
          _this.node.getParent().getChildByName("Score").runAction(cc.fadeIn(.1));
          _this.node.getParent().getChildByName("back").runAction(cc.fadeOut(.1));
          _this.node.group = "default";
          addScore && Game_1.Game.addScore(_this.score, _this.score, 1.5, CMath.ConvertToNodeSpaceAR(_this.node, Game_1.Game.TopNode).add(cc.v2(.5 * Const_1.BubbleSize.width, .5 * Const_1.BubbleSize.height)));
        })));
      };
      var Bird_1;
  ...
  BubbleMatrix: [ function(require, module, exports) {
    ...
    var BubbleMatrix = function() {
      ...
      BubbleMatrix.prototype.initBubbleData = function() {
        ...
        var birdData = {};
        var birdIndex = Const_1.BirdIndexRandom[Math.floor(CMath.getRandom() * Const_1.BirdIndexRandom.length)];
        for (var _i = 0, birdIndex_1 = birdIndex; _i < birdIndex_1.length; _i++) {
          var index = birdIndex_1[_i];
        ...
        for (var i = startIndex; i <= endIndex; i++) {
          ...
          var neiberColors = [];
          for (var _a = 0, neibers_1 = neibers; _a < neibers_1.length; _a++) {
            var index = neibers_1[_a];
        ...
        if (this.isShooterState || this.isDrop) {
          ...
          for (var i = 0; i < count; i++) {
            ...
            if (this.isDrop && pos.y <= exports.DropBorder) {
              ...
              } else this.bubble.playAnimation(BubbleDrop_1.default, function() {
                GameFactory_1.gFactory.putBubble(_this.node);
              });
              break;
            }
  ...
  Const: [ function(require, module, exports) {
    ...
    exports.BubbleColors = [ BubbleType.Yellow, BubbleType.Red, BubbleType.Purple, BubbleType.Green, BubbleType.Blue, BubbleType.White, BubbleType.Boom ];
    var BirdIndex1 = [ 79, 85, 124, 130, 157 ];
    var BirdIndex2 = [ 64, 70, 97, 139, 145 ];
    exports.BirdIndexRandom = [ BirdIndex1, BirdIndex2 ];
    var SpecialType;
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.onLoad = function() {
        ...
        this.ChangeButton.node.active = true;
        this.ChangeButton.interactable = true;
        ...
        for (var _i = 0, _a = this.BirdRoot.children; _i < _a.length; _i++) {
          var child = _a[_i];
          child.getChildByName("Score").opacity = 0;
        }
        var self = this;
      ...
      GameScene.prototype.initEvent = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.GET_TREASURE, function(name, bubble) {
          var bridRoot = _this.BirdRoot.getChildByName(name.toString());
          if (null == bridRoot) return;
          var bird = GameFactory_1.gFactory.getBird(200 * name, CMath.ConvertToNodeSpaceAR(bubble, bridRoot));
          bridRoot.addChild(bird);
        }, this);
      ...
      GameScene.prototype.putNextShooterBubble = function() {
        ...
        bubble.runAction(cc.sequence(cc.fadeTo(0, 255), cc.scaleTo(.1, 1.2, 1.4), cc.scaleTo(0, 1, 1.4), cc.spawn(cc.scaleTo(.1, .8, 1.6), cc.moveBy(.1, 0, this.psitonOffset).easing(cc.easeIn(.1))), cc.moveTo(0, 0, 0), cc.scaleTo(0, 0, 0), cc.scaleTo(.1, 1, 1), cc.callFunc(function() {
          ...
          if (bubble.getComponent(Bubble_1.default).Type == Const_1.SpecialType.Normal) {
            EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_horce");
      ...
      GameScene.prototype.getNewTask = function(count) {
        ...
        var _loop_3 = function(i) {
          ...
          if (0 == i) {
            ...
            bubble.runAction(cc.sequence(cc.fadeTo(0, 255), cc.callFunc(function() {
              if (horce_1) {
                EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.PLAY_EFFECT, "change_horce");
                bubble.getComponent(Bubble_1.default).setColor(Const_1.BubbleType.Horce, Const_1.SpecialType.Horce);
                bubble.getComponent(Bubble_1.default).playAnimation(BubbleHorce_1.default, function() {
      ...
      GameScene.prototype.addScore = function(score, scale, pos, isFLoat) {
        ...
        if (false == isFLoat) {
          this.score = Game_1.Game.getScore();
    ...
    var LoadingImg = function(_super) {
      ...
      LoadingImg.prototype.onLoad = function() {
        ...
        EventManager_1.gEventMgr.on(EventName_1.GlobalEvent.Hide_Load, function() {
          ...
          _this.node.runAction(cc.sequence(cc.delayTime(delayTime), cc.fadeOut(.05), cc.callFunc(function() {
  ...
  LogHandler: [ function(require, module, exports) {
    ...
    var LogHandler = function() {
      ...
      LogHandler.VERSION = "Bust-A-Move version 29 : ";
  ...
  ResultLayer: [ function(require, module, exports) {
    ...
    var ResultLayer = function(_super) {
      ...
      ResultLayer.prototype.onLoad = function() {
        ...
        this.updateScore();
        for (var _i = 0, _a = this.Equip.children; _i < _a.length; _i++) {
          var child = _a[_i];
          child.getChildByName("Back").opacity = 255;
          child.getChildByName("Bird").scale = 0;
          if (parseInt(child.name) <= Game_1.Game.treasureCount) {
            child.getChildByName("Back").runAction(cc.sequence(cc.delayTime(parseInt(child.name) / 6), cc.fadeOut(.1)));
            child.getChildByName("Bird").runAction(cc.sequence(cc.delayTime(parseInt(child.name) / 6), cc.scaleTo(.1, 1.2), cc.scaleTo(.1, 1)));
          }
        }
        this.Submit.scale = 0;
        this.Result.scale = 0;
