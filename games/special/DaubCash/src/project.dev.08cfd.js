window.__require = function e(t, n, r) {
      ...
      GameScene.prototype.update = function(dt) {
        if (Game_1.Game.isStart) {
          ...
          if (Game_1.Game.isToolFull) {
            ...
            if (this.remindCDTime >= 5 && this.RemindNode.opacity <= 0 && this.RemindNode.getNumberOfRunningActions() <= 0) {
              this.RemindNode.stopAllActions();
              this.RemindNode.opacity = .1;
              this.RemindNode.runAction(cc.repeatForever(cc.sequence(cc.fadeIn(.1), cc.delayTime(2), cc.fadeOut(.15), cc.delayTime(5))));
            }
  ...
  LogHandler: [ function(require, module, exports) {
    ...
    var LogHandler = function() {
      ...
      LogHandler.VERSION = "Daub Cash version 50  : ";
