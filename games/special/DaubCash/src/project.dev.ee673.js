window.__require = function e(t, n, r) {
  ...
  Const: [ function(require, module, exports) {
    ...
    (function(SkillType) {
      ...
      SkillType[SkillType["Skip"] = 6] = "Skip";
  ...
  GameScene: [ function(require, module, exports) {
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.changeSkillOrder = function() {
        var _this = this;
        if (false == this.ChangeButton.interactable) {
          console.log(" change button interactable false");
          return;
        }
        if (this.SkillRoot.childrenCount < 2) {
          console.log(" \u9053\u5177\u6570\u91cf\u4e0d\u8db3\u4e24\u4e2a\uff0c\u65e0\u6cd5\u4ea4\u6362");
          return;
        }
        var bottomSkill = this.SkillRoot.children[0];
        bottomSkill.runAction(cc.sequence(cc.callFunc(function() {
          for (var i = 0; i < _this.SkillRoot.childrenCount; i++) _this.SkillRoot.children[i].getComponent(Skill_1.default).unready();
        }), cc.moveTo(.15, 0, 214), cc.callFunc(function() {
          _this.SkillRoot.children.splice(0, 1);
          _this.SkillRoot.children.push(bottomSkill);
          for (var i = 0; i < _this.SkillRoot.childrenCount; i++) {
            var child = _this.SkillRoot.children[i];
            child.zIndex = i + 1;
            child.zIndex < _this.SkillRoot.childrenCount && (child.y = 67 + 5 * (child.zIndex - 1));
            console.log(" zIndex:", child.zIndex, Const_1.SkillType[child.getComponent(Skill_1.default).Type]);
          }
        }), cc.moveTo(.1, 0, 67 + 5 * (this.SkillRoot.childrenCount - 1)), cc.callFunc(function() {
          _this.SkillRoot.children[_this.SkillRoot.childrenCount - 1].getComponent(Skill_1.default).turnReady();
        })));
      };
      GameScene.prototype.initEvent = function() {
        ...
        this.ChangeButton.interactable = this.SkillRoot.childrenCount >= 2;
        this.ChangeButton.node.on(cc.Node.EventType.TOUCH_END, this.changeSkillOrder, this);
        ...
        this.SkillRoot.on(cc.Node.EventType.CHILD_ADDED, function() {
          ...
          _this.ChangeButton.interactable = _this.SkillRoot.childrenCount >= 2;
        }, this);
        this.SkillRoot.on(cc.Node.EventType.CHILD_REMOVED, function() {
          _this.SkillRoot.childrenCount >= 1 && _this.SkillRoot.children[_this.SkillRoot.childrenCount - 1].getComponent(Skill_1.default).turnReady();
      ...
      GameScene.prototype.addSkill = function() {
        ...
        switch (skill) {
         ...
         case Const_1.SkillType.Skip:
          skillCallback = this.skipSkill.bind(this);
          icon = Const_1.UI_Atlas.Skill_Icon_Skip;
        }
        ...
        for (var _i = 0, _a = this.SkillRoot.children; _i < _a.length; _i++) {
          var child = _a[_i];
          child.getComponent(Skill_1.default).unready();
        }
      ...
      GameScene.prototype.skipSkill = function() {
        if (Game_1.Game.getGameTime() <= 0) {
        ...
        var child = this.CurrentPoint.children[0];
        if (null == child) {
          console.log(" has no point!");
          return;
        }
        var point = child.getComponent(Point_1.default);
        if (null == point) {
  ...
  Game: [ function(require, module, exports) {
    ...
    var GameCtrl = function() {
      ...
      GameCtrl.prototype.initSkillPool = function(count) {
        var pool = [ Const_1.SkillType.Star, Const_1.SkillType.Gold, Const_1.SkillType.Time, Const_1.SkillType.Magic, Const_1.SkillType.Skip ];
        var poolWithoutSkipNTime = [ Const_1.SkillType.Star, Const_1.SkillType.Gold, Const_1.SkillType.Magic ];
        for (var i = 0; i < count; i++) {
          var randomPool = [];
          this.toolRound++;
          randomPool = this.toolRound <= 3 ? poolWithoutSkipNTime.concat() : pool.concat();
          if (this.timeToolTotalCount >= this.TIME_TOOL_COUNT_LIMIT) {
          ...
          if (this.skipToolTotalCount >= this.SKIP_TOOL_COUNT_LIMIT) {
            var index = randomPool.indexOf(Const_1.SkillType.Skip);
            index >= 0 && randomPool.splice(index, 1);
          }
          ...
          randomPool.length <= 0 && (randomPool = this.toolRound <= 3 ? poolWithoutSkipNTime.concat() : pool.concat());
          var poolarr = [];
          ...
          skill == Const_1.SkillType.Time ? this.timeToolTotalCount++ : skill == Const_1.SkillType.Skip && this.skipToolTotalCount++;
  ...
  Guide: [ function(require, module, exports) {
    ...
    var Game_1 = require("./Controller/Game");
    var Const_1 = require("./Const");
    var MouseGuidePage_1 = require("./MouseGuidePage");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var GuideType;
    (function(GuideType) {
    ...
    var Guide = function(_super) {
      ...
      Object.defineProperty(Guide.prototype, "SkipGuide", {
        get: function() {
      ...
      Object.defineProperty(Guide.prototype, "SkipOJBK", {
        get: function() {
      ...
      Guide.prototype.showMouseGuide = function(closeCallback) {
        ...
        this.SkipGuide.active = false;
        this.callback = closeCallback;
        this.MouseOJBK.active = false;
        var page = this.MouseGuide.getChildByName("MouseGuidePage").getComponent(MouseGuidePage_1.default);
        page.reset();
        page.onComplete = function() {
          _this.MouseOJBK.active = true;
        };
      };
      ...
      Guide.prototype.showSkipGuide = function(closeCallback) {
        this.node.active = true;
        this.SkillGuide.active = true;
        this.Button.active = false;
        this.HelpView.node.active = false;
  ...
  MouseGuidePage: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d8f62swh41NQrpkpv9WU4DY", "MouseGuidePage");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Const_1 = require("./Const");
    var FrameAniBase_1 = require("./FrameAniBase");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var MouseGuidePage = function(_super) {
      __extends(MouseGuidePage, _super);
      function MouseGuidePage() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.SuperLightAtlas = null;
        _this.time = 8;
        _this.superHighLightCount = 0;
        return _this;
      }
      Object.defineProperty(MouseGuidePage.prototype, "Light", {
        get: function() {
      ...
      Object.defineProperty(MouseGuidePage.prototype, "Touch", {
        get: function() {
      ...
      Object.defineProperty(MouseGuidePage.prototype, "TimeBar", {
        get: function() {
      ...
      Object.defineProperty(MouseGuidePage.prototype, "TimeLabel", {
        get: function() {
      ...
      MouseGuidePage.prototype.onLoad = function() {
        this.reset();
      };
      Object.defineProperty(MouseGuidePage.prototype, "Time", {
        get: function() {
          return this.time;
        },
        set: function(val) {
      ...
      MouseGuidePage.prototype.updateTouch = function() {
        for (var _i = 0, _a = this.Touch.children; _i < _a.length; _i++) {
          var child = _a[_i];
          var ani = child.getComponent(FrameAniBase_1.default);
          var sprite = child.getComponent(cc.Sprite);
          if (parseInt(child.name) <= this.superHighLightCount) {
            child.active = true;
            sprite.spriteFrame = ani.Frames.getSpriteFrame("ae_new_07");
          } else child.active = false;
        }
      };
      MouseGuidePage.prototype.nextTouch = function() {
        var _this = this;
        this.superHighLightCount++;
        var child = this.Touch.getChildByName(this.superHighLightCount.toString());
        if (child) {
          var ani = child.getComponent(FrameAniBase_1.default);
          child.active = true;
      ...
      MouseGuidePage.prototype.updateLight = function() {
        var _loop_1 = function(child) {
          if (parseInt(child.name) <= this_1.superHighLightCount) {
      ...
      MouseGuidePage.prototype.reset = function() {
        this.superHighLightCount = 0;
        this.Time = 8;
        this.updateTouch();
        this.updateLight();
      ...
      MouseGuidePage.prototype.onComplete = function() {};
      MouseGuidePage.prototype.update = function(dt) {
        this.Time -= dt;
        this.Time <= 0 && this.reset();
      };
      __decorate([ property(cc.SpriteAtlas) ], MouseGuidePage.prototype, "SuperLightAtlas", void 0);
      MouseGuidePage = __decorate([ ccclass ], MouseGuidePage);
      return MouseGuidePage;
    }(cc.Component);
    exports.default = MouseGuidePage;
    cc._RF.pop();
  }, {
    "./Const": "Const",
    "./FrameAniBase": "FrameAniBase"
  ...
  Skill: [ function(require, module, exports) {
    ...
    var Skill = function(_super) {
      ...
      Skill.prototype.reuse = function() {
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, function(event) {
          ...
          if (false == _this.ready) {
            console.error(" skill no ready:", Const_1.SkillType[_this.skillType]);
            return;
          }
          if (Game_1.Game.getGameTime() <= 0) {
          ...
          if (Game_1.Game.checkIsFull(Game_1.Game.cardIndex) && [ Const_1.SkillType.Time, Const_1.SkillType.Skip ].indexOf(_this.skillType) < 0) {
      ...
      Skill.prototype.unready = function() {
        this.ready = false;
      };
      Skill.prototype.turnReady = function() {
        this.ready = true;
      };
