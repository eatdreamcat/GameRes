    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.putNextShooterBubble = function() {
        ...
        bubble.runAction(cc.spawn(cc.fadeTo(.2, 255), cc.moveTo(.2, 0, 0), cc.callFunc(function() {
          if (bubble.getComponent(Bubble_1.default).Type == BubbleMatrix_1.SpecialType.Normal && true) {
      ...
      GameScene.prototype.getNewTask = function(count) {
        ...
        var _loop_3 = function(i) {
          ...
          if (0 == i) {
            ...
            var horce_1 = false;
            if (Game_1.Game.getTaskStreak() >= Const_1.TaskStreakAward || bubble.getComponent(Bubble_1.default).Type == BubbleMatrix_1.SpecialType.Normal && true) {
              Game_1.Game.addTaskStreak(-Game_1.Game.getTaskStreak());
              horce_1 = true;
            }
