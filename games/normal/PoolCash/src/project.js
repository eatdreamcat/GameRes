...
System.register("chunks:///GamePlay/UI/TutorialLayerView.js", ["../../_virtual/_rollupPluginBabelHelpers.js", "cc", "../../Signal/Signal.js", "../../table.js", "../GameObject/TutorialRotation.js", "./MainUI.js", "./PoleTouchView.js", "../GameLogic.js"], function (_export, _context) {
  ...
  var _applyDecoratedDescriptor, _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, v3, SpriteAtlas, Tween, UIOpacity, Node, tween, Sprite, RichText, Component, ShowTutorialSignal, En_View, En_ID, TutorialStep, RotationPoleSignal, PowerUpdateSignal, GameLogic, TutorialStepSignal, _dec, _dec2, _class, _class2, _descriptor, _temp, ccclass, property, Black8Pos, Pink12Pos, Yellow9Pos, TutorialLayerView;
...
System.register("chunks:///GamePlay/GameLogic.js", ["../_virtual/_rollupPluginBabelHelpers.js", "cc", "../Common/ToSingleTon.js", "../Common/HashMap.js", "./GameRule.js", "../Common/Signal.js", "../Signal/Signal.js", "../Common/Random.js", "../Common/Cocos.js", "../Model/PlayModel.js", "../Manager/GameStateController.js", "../TableManager.js", "../Common/SDK/CelerSDK.js", "../App/App.js", "../table.js", "./Model/BallModel.js", "./GameObject/TutorialRotation.js", "./GameObject/BallRoot.js", "./Physics/BorderCollider.js", "./UI/ScoreScaleRoot.js", "./UI/TutorialLayerView.js"], function (_export, _context) {
  ...
  var _inherits, _createClass, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _assertThisInitialized, cclegacy, v3, math, Vec3, SphereCollider, SingleTon, HashMap, ScoreType, GetScoreByType, GetTotalHeartCount, HoleBonus, StreakBonusLimit, BaseSignal, ShotSignal, GameOverSignal, GameReadySignal, Random, disOrderArray, PlayModel, GameStateController, RoundEndType, TableManager, CelerSDK, App, Balls_ID, Level_IsRandom, BallModel, TutorialStep, BallRoot, HoleName, ScoreScaleRoot, Black8Pos, Yellow9Pos, Pink12Pos, NextRountSignal, ReadyNextRoundSignal, PoleRotationInitSignal, WhiteBallReposSignal, BallDropSignal, HoleBonusInitSignal, UpdateHeartCountSignal, DropPocketSignal, RefreshHeartBonusSignal, PocketScoredSignal, TutorialStepSignal, BallReturnSignal, SyncShotLineSignal, ShotType, GameLogic;
      ...
      _export("BallObject", BallObject = (_dec = ccclass("BallObject"), _dec(_class = (_temp = /*#__PURE__*/function (_PrefabView) {
        ...
        _createClass(BallObject, [{
          ...
          value: function onReturn(callback) {
            ...
            this.node.setPosition(v3(this.node.position.x, this.model.Position.y, this.node.position.z));
            Tween.stopAllByTarget(this.node);
            var rotation = math.quat();
            var time = 0.5;
            math.Quat.fromEuler(rotation, 0, 180, 0);
