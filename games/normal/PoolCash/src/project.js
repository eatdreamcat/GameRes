        ...
        _createClass(CelerSDK, [{
          ...
          value: function onCelerStart() {
            ...
            this.match = CELER_X ? celerSDK.getMatch() : {
              ...
              sharedRandomSeed: 0.16574999744893448,
              // Math.random(), //*/0.24907066062871674,//Math.random(),0.9483376662548313, //
              difficultyLevel: 1,
              locale: "en_US"
            };
          ...
          value: function onRotation(step, fromLine) {
            ...
            if (GameLogic.inst.isOnTutorial) {
              if (GameLogic.inst.TutorialStep == TutorialStep.RotatePole) {
                if (rotation.y > 13 && rotation.y < 13.6) {
      ...
      _export("TutorialLayerView", TutorialLayerView = (_dec = ccclass("TutorialLayerView"), _dec2 = property(SpriteAtlas), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        _createClass(TutorialLayerView, [{
          ...
          value: function start() {
            ...
            RotationPoleSignal.inst.addListener(function () {
              Tween.stopAllByTarget(_this2.Hand);
              Tween.stopAllByTarget(_this2.Hand.getComponent(UIOpacity));
              _this2.Hand.active = false;
            }, this);
...
System.register("chunks:///GamePlay/GameLogic.js", ["../_virtual/_rollupPluginBabelHelpers.js", "cc", "../Common/ToSingleTon.js", "../Common/HashMap.js", "./GameRule.js", "../Common/Signal.js", "../Signal/Signal.js", "../Common/Random.js", "../Common/Cocos.js", "../Model/PlayModel.js", "../Manager/GameStateController.js", "../TableManager.js", "../Common/SDK/CelerSDK.js", "../App/App.js", "../table.js", "./Model/BallModel.js", "./GameObject/TutorialRotation.js", "./GameObject/BallRoot.js", "./Physics/BorderCollider.js", "./UI/ScoreScaleRoot.js", "./UI/TutorialLayerView.js"], function (_export, _context) {
  ...
  var _inherits, _createClass, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _assertThisInitialized, cclegacy, v3, math, Vec3, SphereCollider, SingleTon, HashMap, ScoreType, GetScoreByType, GetTotalHeartCount, HoleBonus, StreakBonusLimit, BaseSignal, ShotSignal, GameOverSignal, GameReadySignal, Random, disOrderArray, PlayModel, GameStateController, RoundEndType, TableManager, CelerSDK, App, Balls_ID, Level_IsRandom, BallModel, TutorialStep, BallRoot, HoleName, ScoreScaleRoot, Black8Pos, Yellow9Pos, Pink12Pos, NextRountSignal, ReadyNextRoundSignal, PoleRotationInitSignal, WhiteBallReposSignal, BallDropSignal, HoleBonusInitSignal, UpdateHeartCountSignal, DropPocketSignal, RefreshHeartBonusSignal, PocketScoredSignal, TutorialStepSignal, BallReturnSignal, ShotType, GameLogic;
