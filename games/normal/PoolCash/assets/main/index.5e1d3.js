    ...
    execute: function () {
      ...
      var BallObject = exports('BallObject', (_dec = ccclass("BallObject"), _dec(_class = (_temp = /*#__PURE__*/function (_PrefabView) {
        ...
        _proto.initPhysic = function initPhysic() {
          ...
          this.RigidBody.sleepThreshold = 0.4;
        ...
        _proto.onCollide = function onCollide(a) {
          ...
          velocity.y = 0; // console.log("on collide:", this.model.Point);
        ...
        _proto.onShot = function onShot(power, angleY, forward) {
          ...
          console.log("shot power:", power // ",impulse:",
          // impulse,
          // ",linerVelocity:",
          // this.shotVelocity,
          // ",torque:",
        ...
        _proto.update = function update() {// console.log(this.RigidBody.useCCD);
        };
