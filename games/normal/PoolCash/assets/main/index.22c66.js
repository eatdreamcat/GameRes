        ...
        _proto.onCollide = function onCollide(a) {
          ...
          if (a.selfCollider instanceof SphereCollider && a.otherCollider instanceof SphereCollider) {
            ...
            if (this.model.isWhiteBall && Pole.HitNormal && this.shotVelocity && this.shotImpulse && EasyMode()) {
              ...
              var impulse = Pole.HitNormal.clone().normalize().multiplyScalar(this.shotImpulse.length()).multiplyScalar(ballOtherPhysic.Restitution * ballPhysicWhite.Restitution * ballOtherPhysic.Damping * ballPhysicWhite.Damping * Math.abs(velocity.length() / this.shotVelocity.length()));
              impulse.y = 0;
