      ...
      var BallObject = exports('BallObject', (_dec = ccclass("BallObject"), _dec(_class = (_temp = /*#__PURE__*/function (_PrefabView) {
        ...
        _proto.onCollide = function onCollide(a) {
          ...
          if (a.selfCollider instanceof SphereCollider && a.otherCollider instanceof SphereCollider) {
            ...
            BallHitSignal.inst.dispatch(this.model, otherBallObj.model, Clamp(velocity.length() / 5 * this.RigidBody.mass, 10, 0));
            ...
            if (this.model.isWhiteBall && Pole.HitNormal && this.shotVelocity && this.shotImpulse && EasyMode()) {
              ...
              var impulse = Pole.HitNormal.clone().normalize().multiplyScalar(this.shotImpulse.length()).multiplyScalar(ballOtherPhysic.Damping * ballPhysicWhite.Damping * Math.max(Math.abs(velocity.length() / this.shotVelocity.length()), 0.1));
              impulse.y = 0;
              ...
              CC_DEBUG && console.log("shot impulse:", this.shotImpulse, " orther impulse:", impulse, ",velocity:", velocity, this.shotVelocity, ", ratio:", Math.max(Math.abs(velocity.length() / this.shotVelocity.length()), 0.1), ", hitNormal:", Pole.HitNormal, ",negativeImpulse:", negativeImpulse);
              Pole.HitNormal = null;
              this.shotVelocity = null;
              this.shotImpulse = null;
            }
          ...
          if (a.selfCollider instanceof SphereCollider && a.otherCollider instanceof BoxCollider) {
            ...
            if (borderCollider) {
              ...
              HitBorderSignal.inst.dispatch(borderCollider.type, Clamp(velocity.length() / 25 * this.RigidBody.mass, 8, 0));
            }
          }
        };
